      ...
      <div className="max-w-md mx-auto px-6">
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <div className="p-4 rounded-2xl" style={{ background: 'linear-gradient(135deg, #749bc2 0%, #4682a9 100%)' }}>
          ...
          <p className="text-gray-600">
            {isSignUp 
              ? 'Join AgentHub and start building your AI agent collection'
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full text-white py-3 px-4 rounded-xl font-semibold transition-colors text-lg"
